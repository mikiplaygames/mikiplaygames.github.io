      ...
      <article class="service-card game-card">
        ...
        ${r.responsibilities&&r.responsibilities.length>0?`
          <div class="game-card__responsibilities">
            ...
            <ul>
              ${r.responsibilities.map(l=>`<li>${l}</li>`).join("")}
            </ul>
          </div>
        `:""}
